...
using NADAVehiclePricing.APIClients;

namespace NADAVehiclePricing
{
    public class NADAVehiclePricingClient
    {
        public string Authorization { get; private set; }
        public readonly VehiclePricingAPIClient VehiclePricingAPIClient;
        ...
        public NADAVehiclePricingClient(string client_id, string client_secret, EnvironmentType type = EnvironmentType.Production)
        {
            baseUri = new Uri(type.ToDescriptionString());
            Authorization = MBAuthorizations(client_id, client_secret);
            VehiclePricingAPIClient = new VehiclePricingAPIClient(Authorization, baseUri);
        }
